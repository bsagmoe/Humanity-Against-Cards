const WHITE_CARDS = [
	...
	"Congress' flaccid penises whithering away beneath their suit pants.",
	...
	"The Great Lizard Uprising of 2238.",
	...
	"Totally suckable feet.",
	"Fading away into nothingness.",
	"Sitting like two seats away from Matthew Perry.",
	"Crab apples all over the fucking sidewalk.",
	"A suitcase of sedated birds.",
	"Fish sauce.",
	"The decadence of the West.",
	"Being the one person who is John Travolta.",
	"Rachel Ray's floating, disembodied head.",
...
const SFW_WHITE_CARDS = [
	...
	"Graphic violence, adult language, and some sexual content.",
	"Survivor's guilt.",
	"A slightly more terrible parallel universe.",
	"An army of skeletons.",
	"Boris the Soviet Love Hammer.",
	"Oncoming traffic.",
	"Being awesome at sex.",
	...
	"Drinking ten 5-hour ENERGYs to get 50 continuous hours of energy.",
	"An all-midget production of Shakespeare's Richard III.",
	"Some tool with an acoustic guitar.",
	"Disco fever.",
	"Screaming like a maniac.",
	"Flying robots that kill people.",
	"A botched circumcision.",
	...
	"A Ugandan warlord.",
	"Whatever a McRib is made of.",
	"10 Incredible Facts About the Butthole.",
	"Actual mutants with medical conditions and no superpowers.",
	"A Native American who solves crimes by going into the spirit world.",
	"Sugar madness.",
	"Three consecutive seconds of happiness.",
	...
	"P.F. Chang himself.",
	"An inability to form meaningful relationships.",
	"A hug from UNC basketball favorite Kennedy Meeks.",
	"A zero-risk way to make $2,000 from home.",
	"Getting drive-by shot.",
	"Seeing my village burned and my family slaughtered before my eyes.",
	"The passage of time.",
	...
	"Being a terrible mother.",
	"Never having sex again.",
	"A pizza guy who messed up.",
	"A whole lotta woman.",
	"The all-new Nissan Pathfinder with 0.9% APR financing.",
	"A peyote-fueled vision quest.",
	"Kale.",
	"Singing Viva La Viva loudly in Wilson Library.",
	"Crippling social anxiety.",
	"Immortality cream.",
	"Texas.",
	"Shapes and colors.",
	...
	"The Y2K bug.",
	"Wearing Nicolas Cage's face.",
	"Aggressively stabbing a Capri Sun.",
	"Kurt Cobain's death.",
	"Freeing Willy.",
	"Liking big butts and not being able to lie about it.",
	"The Great Cornholio.",
	...
	"Reconciling quantum theory with general relativity.",
	"Insufficient serotonin.",
	"The awesometastic coach Roy Williams.",
	"UNC's academic advising department.",
	"Getting really worried about global warming for a few seconds.",
	"Infinity.",
	"Oxytocin release via manual stimulation of the nipples.",
	"Uranus.",
	...
	"Space Jam on VHS.",
	"Immaculate conception.",
	"Messing up 'Silent Night' in front of 300 parents.",
	"A visually arresting turtleneck.",
	"A toxic family environment.",
	"Eating an entire snowman.",
	"Rudolph's bright red balls.",
	"The Grinch's musty pelt.",
	"Breeding elves for their priceless ears.",
	"Throwing bread into Santa's beard.",
	"Finding out that Santa isn't real.",
	...
	"These low, low prices.",
	"A magical tablet containing a world of unlimited pornography.",
	"Garbage Christmas cards with no money in them.",
	"People with cake in their mouths talking about how good cake is.",
	"Being blind and deaf and having no limbs.",
	"A simultaneous nightmare and wet dream starring Sigourney Weaver.",
	"Having a strong opinion about Obamacare.",
	...
	"Feeding a man a pie made of his own children.",
	"Ribs so good they transcend race and class.",
	"The sensitive European photographer who's seeing my wife.",
	"Making it look like a suicide.",
	"An older man.",
	"A much younger woman.",
	"Punching a congressman in the face.",
	...
	"Fading away into nothingness.",
	"Sitting like two seats away from Matthew Perry.",
	"Crab apples all over the sidewalk.",
	"A suitcase of sedated birds.",
	"Fish sauce.",
	"The decadence of the West.",
	"Being the one person who is John Travolta.",
	...
	"The dopest professor in all the land, KMP.",
	"A Japanese tourist who wants something very badly but cannot communicate it.",
	"A pangender octopus who roams the cosmos in search of love.",
	"Carson Daly.",
	"Smurfs.",
	"Hinton James's long walk to UNC.",
	"The Clef Hangers.",
	"Drowning the kids in the bathtub.",
	"Falling through the floor.",
	"Horse legs.",
	"An F on the Comp 426 final.",
	"The food at Lenior Dining Hall on an off day.",
	"Turning it up at the Sitterson comp sci building.",
	"A booth at Linda's bar and grill.",
	"Marcus Paige's game tying jumpshot against Villanova.",
	"The disappointment following Villanova's buzzer-beater shot to take the NCAA Tourney from UNC",
	"A postracial utopia."
];
const SFW_BLACK_CARDS = [
	"What ended my last relationship?",
	"__________. It's a trap!",
	"__________. High five, bro.",
	"I got 99 problems but __________ ain't one.",
	"__________ might make a good replacement for the missing bricks in the campus sidewalks.",
	"The new organization dedicated to __________ is going to have trouble getting Fallfest approval.",
	"How am I maintaining my relationship status?",
	"The new Chevy Tahoe. With the power and space to take __________ everywhere you go.",
	"When Pharaoh remained unmoved, Moses called down a Plague of __________.",
	"I was kicked out off the Daily Tar Heel for writing a completely accurate article about __________.",
	"In the new Disney Channel Original Movie, Hannah Montana struggles with __________ for the first time. ",
	"While the United States raced the Soviet Union to the moon, the Mexican government funneled millions of pesos into research on __________.",
	"This is the way the world ends / This is the way the world ends / Not with a bang but with __________.",
	"Dear Abby, I'm having some trouble with __________ and would like your advice.",
	...
	"Coming to Broadway this season, __________: The Musical.",
	"What am I giving up for Lent?",
	"Along with top grades, a drink from the Old Well grants you __________.",
	"What will always get you laid?",
	"The Smithsonian Museum of Natural History has just opened an interactive exhibit on __________.",
	"What are my parents hiding from me?",
	"Maybe she's born with it. Maybe it's __________.",
	...
	"How am I compensating for my tiny penis?",
	"Dear Leader Kim Jong Un, our village praises your infinite wisdom with a humble offering of __________.",
	"Do not mess with me! I am literally __________ right now.",
	"This is the prime of my life. I'm young, hot, and full of __________. ",
	"You've seen the bearded lady! You've seen the ring of fire! Now, ladies and gentlemen, feast your eyes upon __________!",
	"Yo' mama so fat she __________!",
	"Hi, this is Jim from accounting. We noticed a $1,200 charge labeled '__________.' Can you explain?",
	...
	"What keeps me warm during the cold, cold winter?",
	"Wake up, America. Christmas is under attack by secular liberals and their __________.",
	"Near the end of the UNC/Clemson bowl game, the refs missed the call because they were preoccupied with __________.",
	"I really hope my grandma doesn't ask me to explain __________ again. ",
	"Blessed are you, Lord our God, creator of the universe, who has granted us __________.",
	"Because they are forbidden from masturbating, Mormons channel their repressed sexual energy into __________.",
	"Kids these days with their iPods and their Internet. In my day, all we needed to pass the time was __________.",
	...
	"Dear Mom and Dad, Camp is fun. I like capture the flag. Yesterday, one of the older kids taught me about __________. I love you, Casey",
	"Why am I so tired?",
	"The feeling of graduating from UNC is best embodied by __________.",
	"Behold the Four Horsemen of the Apocalypse! War, Famine, Death, and __________. ",
	"Looking to earn some big bucks? Learn how to make __________ work for you!",
	"How are the writers of Cards Against Humanity spending your $25?",
	"I'm not going to lie. I despise __________. There, I said it.",
	...
	"Our relationship is strictly professional. Let's not complicate things with __________.",
	"Meryl Streep + __________ = Oscar.",
	"__________ is way older than UNC, the US's oldest public university chartered in 1789.",
	"Hey Reddit! I'm __________. Ask me anything.",
	"I'm going on a cleanse this week. Nothing but kale juice and __________.",
	"Well, gentlemen! If you'll excuse me, I have a date with __________.",
	"One thing you need to pass Comp 426 is __________.",
	"The craziest thing I did my first year at UNC involved __________.",
	"What's Dukes unofficial mascot?",
	"UNC Student Stores always mark up the price on __________.",
	"At the request of students Saunders Hall is being renamed after __________.",
	"The strangest art display I've ever seen in Hanes art was a diorama accurately depicting __________.",
	"The only thing more stressful than finals week is __________.",
	"Gary 'the pit preacher' forgot to warn you about __________.",
	"UNC STV was running out of ideas, so they made a hit show about __________.",
	"UNC Students set __________ on fire to celebrate their victory over Dook.",
	"Our demands are quite simple. We will execute a hostage every hour until you bring us __________."
];
...
module.exports = {
	...
	SFW_WHITE_CARDS: SFW_WHITE_CARDS,
	SFW_BLACK_CARDS: SFW_BLACK_CARDS
}
